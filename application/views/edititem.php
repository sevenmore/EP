...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>SuperShop Edit item</title>
	...
	<body>		
		...
		<section id="addseller">
			<h2>Edit item</h2>
			<?php echo form_open('edititem/save',array('class'=>'ovitek-seller')); ?>
				<div>
				...
				<div>
					...
					<?php 
					$category=array('Running'=>'Running', 'Casual'=>'Casual','Summer'=>'Summer');
					echo form_dropdown('category', $category, $edit->category,'class="polja-drop"');
					?>
				</div>
				...
				<div>
					...
					<input id="price" class="polja" type="text" name="price" value="<?php echo set_value('price',$edit->price); ?>" placeholder="Price">
				</div>
				<?php echo form_error('price', '<label class="error error-seller">', '</label>'); ?>
				
				<div>
					<label class="control-label">Photo:</label>									
					<input id="photo" class="polja" type="text" name="photo" value="<?php echo set_value('email',$edit->photo); ?>" placeholder="Photo">
				</div>
				<?php echo form_error('photo', '<label class="error error-seller">', '</label>'); ?>

				<input type="hidden" name="item_id" value="<?php echo set_value('item_id',$edit->item_id); ?>">
