...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>SuperShop Edit seller</title>
	...
	<body>		
		...
		<section id="addseller">
			<h2>Edit seller</h2>
			<?php echo form_open('editseller/save',array('class'=>'ovitek-seller')); ?>
				<div>
				...
				<div>
					...
					<input id="emso" class="polja" type="text" name="emso" value="<?php echo set_value('emso',$edit->emso); ?>" placeholder="EMSO">
				</div>
