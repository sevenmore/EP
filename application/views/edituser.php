...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>SuperShop Edit user</title>
		...
		<section id="addseller">
			...
			<?php echo form_open('edituser/save',array('class'=>'ovitek-seller')); ?>
				<div>
					...
					<input id="name" class="polja" type="text" name="name" value="<?php echo set_value('name',$edit->name); ?>" placeholder="Name">
				</div>
				<?php echo form_error('name', '<label class="error error-seller">', '</label>'); ?>
				
				<div>
					<label class="control-label">Surname:</label>									
					<input id="surname" class="polja" type="text" name="surname" value="<?php echo set_value('surname',$edit->surname); ?>" placeholder="Surname">
				</div>
				<?php echo form_error('surname', '<label class="error error-seller">', '</label>'); ?>
				
				<div>
					<label class="control-label">Address:</label>									
					<input id="address" class="polja" type="text" name="address" value="<?php echo set_value('address',$edit->address); ?>" placeholder="Address">
				</div>
				<?php echo form_error('address', '<label class="error error-seller">', '</label>'); ?>
				
				<div>
					<label class="control-label">City:</label>									
					<input id="city" class="polja" type="text" name="city" value="<?php echo set_value('city',$edit->city); ?>" placeholder="City">
				</div>
				<?php echo form_error('city', '<label class="error error-seller">', '</label>'); ?>
				
				<div>
					<label class="control-label">Post number:</label>									
					<input id="post" class="polja" type="text" name="post" value="<?php echo set_value('post',$edit->post); ?>" placeholder="Post number">
				</div>
				<?php echo form_error('post', '<label class="error error-seller">', '</label>'); ?>
				
				<div>
					<label class="control-label">E-mail:</label>									
					<input id="email" class="polja" type="text" name="email" value="<?php echo set_value('email',$edit->email); ?>" placeholder="E-mail">
				</div>
				<?php echo form_error('email', '<label class="error error-seller">', '</label>'); ?>
				
				<div>
					<label class="control-label">Phone:</label>									
					<input id="phone" class="polja" type="text" name="phone" value="<?php echo set_value('phone',$edit->phone); ?>" placeholder="Phone number">
				</div>
				...
				<input type="hidden" name="user_id" value="<?php echo set_value('user_id',$edit->user_id); ?>">
